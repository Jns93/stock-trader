...
export default {
    ...
    methods: {
        ...
        saveData() {
            //Atribuição abaixo usando operador destructor
            const { funds, stockPortfolio, stocks } = this.$store.getters //Ha um getter chamado funds, outro chamado stockPortfolio e outro stock. O vue atribui os valores de acordo com os nomes
